...
export default function InputBar({ theme, onSend, isStreaming = false }) {
  ...
  return (
    <div className={`input-glow flex flex-col rounded-2xl border transition-all
      ...
      <textarea
        ...
        placeholder={isStreaming ? 'Gyanix is thinking...' : 'Message Gyanix...'}
      ...
      <div className="flex items-center justify-between px-3 pb-3 pt-1">
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-2 rounded-lg transition-colors
              ...
              ${dark ? 'text-gray-500 hover:text-gray-300 hover:bg-white/5' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-100'}`}
        ...
        <div className="flex items-center gap-2">
          {isStreaming ? (
            <span className={`text-[10px] font-mono flex items-center gap-1 ${dark ? 'text-indigo-400' : 'text-indigo-500'}`}>
              <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 dot-1 inline-block" />
              <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 dot-2 inline-block" />
              <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 dot-3 inline-block" />
            </span>
          ) : (
